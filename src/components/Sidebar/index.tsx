...
export default function SideBar({ isOpen  }: SidebarProps) {
    ...
    return (
        <div
          className={`fixed top-0 left-0 h-full w-64 bg-white text-green-600 dark:bg-black dark:text-green-600 p-4 z-50 transform ${
        ...
        >
          <div className="w-92 flex flex-col items-center">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/extract" className="flex items-center px-4 py-2 text-black dark:text-gray-500 hover:bg-gray-700 hover:text-white">
                  Extrato
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/habits" className="flex items-center px-4 py-2 text-black dark:text-gray-500 hover:bg-gray-700 hover:text-white">
                  Hábitos (Calendário)
                </Link>
              </li>
              <li>
