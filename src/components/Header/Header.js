...
import { GiBullHorns, GiHamburgerMenu } from 'react-icons/gi'
import { AiOutlineClose } from 'react-icons/ai'

// import Sidebar from "../Sidebar/Sidebar"; Desativado temporariamente
...
function Header() {
    ...
    return (
        ...
        <header className="">
            ...
            {/* SideBar separar em um componente */}
            <div className={ openSideBar ? classesPadroes : "hidden"}>
                ...
                <ul className="space-y-2 text-sm">
                    ...
                    <li>
                        <Link to="/dashboard" className="flex items-center space-x-3 text-gray-200 p-2 rounded-md font-medium hover:bg-green-600 focus:shadow-outline">
                            <span className="text-gray-600">
                                <svg className="h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokewidget="2" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                </svg>
            ...
            <nav className="w-full flex items-center justify-between flex-wrap bg-black p-6 animacao-padrao">
                ...
                <div className="hidden md:flex items-center flex-no-shrink  text-green-600 animacao-padrao">
                    <span className="font-extrabold text-xl tracking-tight mr-6">Loki</span>
                    <Link
                        to="/home"
                    >
                        <GiBullHorns size={54} />
