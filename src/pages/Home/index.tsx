    ...
    return (
        <div >
            ...
            <div className="grid md:grid-cols-4 gap-4">
                ...
                <div className="p-5 border dark:border-black hover:border-green-600 dark:hover:border-green-600 rounded-lg bg-slate-950 bg-opacity-50 ">
            ...
            <div className="grid md:grid-cols-2 gap-4 mt-5 ">
                <div className="p-5 border dark:border-black hover:border-green-600 dark:hover:border-green-600 rounded-lg bg-slate-950 bg-opacity-50 h-96 overflow-y-auto">
                ...
                <div className="p-5 border h-96 dark:border-black hover:border-green-600 dark:hover:border-green-600 rounded-lg bg-slate-950 bg-opacity-50">
